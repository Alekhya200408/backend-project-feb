...
// Aggregation pipeline and it returns values in array form
const getUserChannelProfile=asyncHandler(async(req,res)=>{
    ...
    const channel = await User.aggregate([
        ...
        },
        {
            // for subscriber
            $lookup:{
                from:"subscriptions", //it should be prural and lowercase
                localField:"_id",
                foreignField:"channel",
                as:"subscribers"//it becomes a field
            }
        },
        {
            // for subscribed
            $lookup:{
                ...
                as:"subscribedTo"//it becomes a field
            }
        },
        {  
            // it adds new information in the main user scheema
            $addFields:{
                subscribersCount:{
                    $size:"$subscribers"
                },
...
// new aggregation pipeline of watchHistory
